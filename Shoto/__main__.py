...
import Shoto.modules.sql.users_sql as sql
from typing import Optional
from Shoto import pbot, telethn 
...
from Shoto.modules import ALL_MODULES
from Shoto.modules.helper_funcs.chat_status import is_user_admin
from Shoto.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Shoto.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            Shotorobot_IMG, caption= "I'm awake already!\n<b>Haven't slept since:</b> <code>{}</code>".format(
                uptime
            ),
...
def Shotorobot_about_callback(update, context):
    query = update.callback_query
    if query.data == "SuzuneHorikitarobot_":
        query.message.edit_text(
            text=""" *Shoto Todoroki* - A bot to manage your groups with additional features!
            \nHere the basic help regarding use of Shotorobot.
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="Back", callback_data="Shoto_back")],
                ]
            ),
        )
    elif query.data == "Shotorobot_back":
        first_name = update.effective_user.first_name
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
    ...
    elif query.data == "Shotorobot_basichelp":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Aᴅᴍɪɴ", callback_data="Shotorobot_admin"),
                    InlineKeyboardButton(text="Nᴏᴛᴇꜱ", callback_data="Shotorobot_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", callback_data="Shotorobot_support"),
                    InlineKeyboardButton(text="Cʀᴇᴅɪᴛ", callback_data="Shotorobot_credit"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="Shotorobot_back"),
                 
                 ]
                ]
            ),
        )
    elif query.data == "Shotorobot_admin":
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="Shotorobot_basichelp")]]
            ),
        )

    elif query.data == "Shotorobot_notes":
        query.message.edit_text(
    ...
    elif query.data == "Shotorobot_asst":
        query.message.edit_text(
            ...
            f"\n\n *Lets Enjoy The Shoto Todoroki Music And Join Support Group @Shoto_xxSupport *"
            f"\n\n*By Suzune Team~*",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
    ...
    elif query.data == "Shotorobot_support":
        query.message.edit_text(
            text="* Shoto Support Chats*"
    ...
    elif query.data == "Shotorobot_credit":
        query.message.edit_text(
            text=f"<b> CREDIT FOR Shoto DEV'S</b>\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    ...
                    InlineKeyboardButton(text="Dᴇ Cᴏᴅᴇ", url="https://t.me/Shoto_xxsupport +"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="Shotorobot_basichelp"),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yo! Me iz amlive")
        except Unauthorized:
            LOGGER.warning(
